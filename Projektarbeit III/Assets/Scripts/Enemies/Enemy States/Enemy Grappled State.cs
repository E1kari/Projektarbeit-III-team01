...
public class EnemyGrappledState : Interface.IState
{
    ...
    public void UpdateState()
    {
        ...
        enemy.gameObject.GetComponent<Rigidbody2D>().linearVelocity = distanceToPlayer.normalized * player.GetComponent<S_MovementEditor>().enemyHookSpeed; // Moves the enemy towards the player
    }
